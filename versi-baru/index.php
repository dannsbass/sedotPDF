...
// echo Bot::setWebhook('https://sedotpdfbot.bintulabun.repl.co'); exit;
...
Bot::document(function(){
  ...
  if($msg['from']['id'] != 1231968913) return;
...
Bot::cmd('/unduh', function($text){
  ...
  if ($message['from']['id'] != 1231968913) return;
...
Bot::text(function($text){
  ...
  Bot::sendMessage($text, ['chat_id'=>-1001834833525]); //laporan
